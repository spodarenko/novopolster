...
function Marquee({
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "np-hero-marquee",
    style: {
      overflow: 'hidden',
      width: '100%'
    }
  }, /*#__PURE__*/React.createElement("div", {
    className: "np-hero-marquee-track",
    style: {
      display: 'flex',
      gap: 'var(--space-10)',
      width: 'max-content'
    ...
    const observer = new IntersectionObserver(([entry]) => {
      if (entry.isIntersecting && !startedRef.current) {
        ...
        const step = now => {
          ...
          setVal(target * eased);
          if (progress < 1) requestAnimationFrame(step);else setVal(target);
        };
...
function RotatingWord({
  ...
  return /*#__PURE__*/React.createElement("span", {
    key: i,
    className: "np-rotate-word",
    style: {
      display: 'inline-block',
      color: '#00DBC8',
      animation: 'np-rotate-word 350ms ease'
    }
  }, words[i]);
}
function Hero({
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    style: {
      padding: isMobile ? '8px 16px 0' : isNarrow ? '10px 24px 0' : '10px 64px 0'
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
    ...
    style: {
      ...
      gap: isMobile ? 12 : 'var(--space-5)',
      minHeight: isNarrow ? 'auto' : 'calc(100vh - 140px)'
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
    ...
    src: base + 'assets/icons/map-pin.svg',
    alt: "",
    style: {
      width: 13,
      height: 13,
    ...
    style: {
      ...
      color: waState === 'hover' ? '#096159' : 'var(--color-brand)',
      textDecoration: 'none',
  ...
  }, t.hero.stats.map(s => /*#__PURE__*/React.createElement("div", {
    key: s.desc,
    style: {
      textAlign: 'center',
      background: 'var(--color-bg-sunken)',
    ...
    style: {
      fontFamily: 'var(--font-display)',
      fontWeight: 900,
      fontSize: isMobile ? 42 : 'clamp(2.25rem, 3vw + 1rem, var(--text-5xl))',
      lineHeight: 1,
    ...
    style: {
      ...
      fontSize: isMobile ? 13 : 'var(--text-sm)',
