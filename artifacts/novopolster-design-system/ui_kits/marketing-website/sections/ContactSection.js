function ContactSection({
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    style: {
      padding: isMobile ? '40px 16px' : isNarrow ? '32px 24px' : '32px 64px',
  ...
  }, t.contact.eyebrow), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 8,
  ...
  }, t.contact.subhead)))), /*#__PURE__*/React.createElement(window.Reveal, {
    delay: 140,
    style: {
      width: 'min(596px, 100%)',
      margin: '0 auto',
  ...
  }, t.contact.formTitle || '30 секунд — і рахунок у вас'), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 20
    ...
    style: labelStyle
  }, t.contact.name, " ", /*#__PURE__*/React.createElement("span", {
    style: {
      color: 'var(--color-brand)'
    }
  }, "*")), /*#__PURE__*/React.createElement("input", {
    style: inputBase,
    placeholder: "\u041C\u0430\u043A\u0441 \u041C\u0443\u0441\u0442\u0435\u0440\u043C\u0430\u043D\u043D",
    required: true
  })), /*#__PURE__*/React.createElement("label", {
    style: {
      display: 'flex',
    ...
    style: labelStyle
  }, t.contact.phone, " ", /*#__PURE__*/React.createElement("span", {
    style: {
      color: 'var(--color-brand)'
    }
  }, "*")), /*#__PURE__*/React.createElement("input", {
    ...
    style: {
      ...inputBase,
      appearance: 'none',
      color: service ? 'var(--color-text-primary)' : 'rgba(19,20,19,0.4)'
    }
  }, /*#__PURE__*/React.createElement("option", {
    value: ""
  }, t.contact.servicePlaceholder), t.servicesGrid.items.map(option => /*#__PURE__*/React.createElement("option", {
    key: option.image,
    value: option.image
  }, option.title.join(' ')))), /*#__PURE__*/React.createElement("img", {
    ...
    style: labelStyle
  }, t.contact.description), /*#__PURE__*/React.createElement("textarea", {
    style: {
      ...inputBase,
      height: 86,
      resize: 'none'
  ...
  }, t.contact.photoGroupTitle || 'Photos', " ", /*#__PURE__*/React.createElement("span", {
    style: {
      color: 'var(--color-text-muted)',
      fontWeight: 400
    }
  }, "(", t.contact.optional || 'optional', ")")), /*#__PURE__*/React.createElement("p", {
    style: {
      margin: '2px 0 0',
      fontFamily: 'var(--font-body)',
      fontSize: 14,
  ...
  }, t.contact.photoGroupHint || 'Up to 4 files, max. 5 MB each. JPG, PNG.')), /*#__PURE__*/React.createElement("div", {
    className: "np-photo-grid",
    onDragOver: e => e.preventDefault(),
    onDrop: e => {
      e.preventDefault();
      replacePhotoIndexRef.current = null;
      selectPhotos(e.dataTransfer.files);
    }
  }, [0, 1, 2, 3].map(index => {
    const file = photos[index];
    const preview = photoPreviews[index];
    return file && preview ? /*#__PURE__*/React.createElement("div", {
      key: index,
      style: {
        position: 'relative',
        aspectRatio: '1',
      ...
      style: {
        ...
        lineHeight: '16px',
        fontWeight: 600,
        textShadow: '0 1px 4px rgba(19,20,19,0.8)',
        pointerEvents: 'none'
      }
      ...
      style: {
        aspectRatio: '1',
        minWidth: 0,
        border: '1px dashed rgba(19,20,19,0.35)',
        borderRadius: 12,
        background: 'var(--color-surface)',
        display: 'flex',
        alignItems: 'center',
  ...
  })), photoError ? /*#__PURE__*/React.createElement("p", {
    role: "alert",
    style: {
      margin: '6px 0 0',
      color: '#B42318',
  ...
  }, photoError) : null)), /*#__PURE__*/React.createElement("label", {
    style: {
      display: 'flex',
      gap: 12,
      alignItems: 'flex-start',
  ...
  }, t.contact.consentPrefix || 'Я погоджуюся з обробкою персональних даних згідно з', " ", /*#__PURE__*/React.createElement("a", {
  ...
  }, t.contact.consentLink || 'Політикою конфіденційності'))), /*#__PURE__*/React.createElement("button", {
    type: "submit",
